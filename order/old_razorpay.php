...
define('DB_HOST', '147.93.98.133');  // Database host
define('DB_USER', 'vaib_user1');       // Database username
define('DB_PASS', 'Abhi235689');           // Database password
define('DB_NAME', 'vaib_db1');  // Database name
...
$api_key = 'rzp_live_0OxrPKEuabTF6e';
$api_secret = 'Sz8DjE0ppUuL8nkjl5yOjOKW';
...
$api_key1 = 'rzp_live_0OxrPKEuabTF6e';
$api_secret1 = 'Sz8DjE0ppUuL8nkjl5yOjOKW';
            ...
            <div class="card-body">
                ...
                <?php if ($payment_success): ?>
                    ...
                    <div class="alert alert-info text-start">
                        <p class="mb-2">युष्य बदन टकणारे ु्तक र्डर कल्या्दल आभार, अपक्षा हे की हे पस्क ुम्ही ंपू्ण वाचल णि त्याच अंलबावणी आपल्ा युष्यात रा.</p>
                        <p class="mb-2">आपण ऑरडर कलेले हे पुसतक आपल्य प्त्यावर ७ त ८ िवसामध् ळुन जाईल.</p>
                        <p class="mb-0">धीर धरा, ू जाऊ नका, वट ीच सुरवत आह लक्ात ेवा आि नवी सुरुव करा ♥️</p>
                    </div>
