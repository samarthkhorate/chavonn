      ...
      <div class="col-xxl">
        <div class="card mb-4">
          <div class="card-header d-flex align-items-center justify-content-between">
           <h5 class="mb-0">Order Your Book</h5>
<small class="text-muted float-end">All fields are mandatory.<!--  Please provide the required details to complete your order. --></small>
...
<form id="myForm" onsubmit="return validateForm(event)" method="post" action="order_place.php">
  ...
  <!-- Road/Street Name -->
  <div class="row mb-3">
    <label class="col-sm-2 col-form-label" for="street-name">Road/Street Name / गल्लीचे/ रोडचे नाव</label>
    <div class="col-sm-10">
      <div class="input-group input-group-merge">
  ...
  <!-- Village/City Name -->
  <div class="row mb-3">
    <label class="col-sm-2 col-form-label" for="city-name">Village/City Name / गावाचे नाव</label>
    <div class="col-sm-10">
      <div class="input-group input-group-merge">
 ...
 <div class="row mb-3">
  ...
  <div class="row mb-3">
    ...
    <div class="col-sm-10">
      <div class="form-check">
        ...
        />
        <label class="form-check-label" for="payOnline">Pay Online (Free Delivery)</label>
      </div>
      <!-- <div class="form-check">
        <input
          class="form-check-input"
          ...
          onclick="updateSummary()"
        />
        <label class="form-check-label" for="payCOD">Cash on Delivery (+ ₹40 Delivery Fee)</label>
      </div> -->
    </div>
  </div>
  ...
  <div class="row mb-3">
    ...
    <div class="col-sm-10">
      <div id="order-summary">
        <p>Book Charges: ₹<span id="bookCharges">270</span></p>
        <p>Delivery Charges: ₹<span id="deliveryCharges">0</span></p>
        <p><strong>Total: ₹<span id="totalAmount">270</span></strong></p>
      </div>
    </div>
  </div>
  ...
  <div class="row justify-content-end">
    <div class="col-sm-10">
      <button type="submit" class="btn btn-primary" id="submit-button">Pay ₹270 Online and Place Order</button>
    </div>
  </div>
</div>
