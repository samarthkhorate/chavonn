...
fbq('init', '1395497635023864');
fbq('track', 'PageView');
</script>
<noscript><img height="1" width="1" style="display:none"
src="https://www.facebook.com/tr?id=1395497635023864&ev=PageView&noscript=1"
/></noscript>
<!-- End Meta Pixel Code -->
    ...
    <div class="col-sm-10">
        <div class="d-flex flex-column flex-sm-row align-items-start">
            <div id="bookImageContainer" class="d-flex mb-2 mb-sm-0 me-sm-3">
                <img id="bookImage1" src="https://vaibhavdhus.com/assets/images/book.png" alt="Book Cover 1" width="100" height="100" class="me-2 me-sm-3" />
                <img id="bookImage2" src="" alt="Book Cover 2" width="100" height="100" class="me-2 me-sm-3 d-none" />
            </div>
            <div class="flex-grow-1">
                <p class="mb-1"><strong id="bookTitle">अंतः अस्ति प्रारंभः (The End is the Beginning) - Marathi Edition - Part 1</strong></p>
                <p class="mb-2">Price: ₹<span id="bookPrice">270</span></p>
                <!-- Quantity Box -->
...
<!-- Language Selection -->
<div class="row mb-3">
    <label class="col-sm-2 col-form-label">Select Language / भाषा निवडा</label>
    <div class="col-sm-10">
        <!-- Marathi Part 1 -->
        <div class="form-check mb-2">
            <input class="form-check-input" type="radio" name="bookLanguage" id="marathiPart1" value="marathi" checked onclick="updateSummary()" />
            <label class="form-check-label" for="marathiPart1">Marathi Edition - Part 1 / मराठी आवृत्ती - भाग १</label>
        </div>
        <!-- Marathi Part 2 -->
        <div class="form-check mb-2">
            <input class="form-check-input" type="radio" name="bookLanguage" id="marathiPart2" value="marathi_part2" onclick="updateSummary()" />
            <label class="form-check-label" for="marathiPart2">Marathi Edition - Part 2 / मराठी आवृत्ती - भाग २</label>
        </div>
        <!-- Marathi Combo -->
        <div class="form-check mb-2">
            <input class="form-check-input" type="radio" name="bookLanguage" id="marathiCombo" value="marathi_combo"  onclick="updateSummary()" />
            <label class="form-check-label" for="marathiCombo">Marathi Combo (Part 1 + Part 2) / मराठी संयोजन (भाग १ + भाग २)</label>
        </div>
        <!-- Hindi Part 1 -->
        <div class="form-check">
            <input class="form-check-input" type="radio" name="bookLanguage" id="hindiPart1" value="hindi"  onclick="updateSummary()" />
            <label class="form-check-label" for="hindiPart1">Hindi Edition - Part 1 / हिंदी आवृत्ती - भाग १</label>
        </div>
    </div>
</div>
...
<div class="row mb-3">
    ...
    <div class="col-sm-10">
        <div id="order-summary">
            <p class="mb-1">Book Charges: ₹<span id="bookCharges">540</span></p>
            <p class="mb-1"><strong style="color: green;">Free Home Delivery</strong></p>
            <p class="mb-0"><strong>Total: ₹<span id="totalAmount">540</span></strong></p>
        </div>
    </div>
</div>
...
<div class="row mb-3">
    <div class="col-sm-10 offset-sm-2">
        <button type="submit" class="btn btn-primary" id="submit-button">Pay ₹540 Online and Place Order</button>
    </div>
</div>
...
<script>
    ...
    const images = {
        marathi: ["https://vaibhavdhus.com/assets/images/book.png"],
        marathi_part2: ["marathi_part_2_front.jpg"],
        marathi_combo: [
            "https://vaibhavdhus.com/assets/images/book.png",
            "marathi_part_2_front.jpg"
        ],
        hindi: ["hindi-front.png"]
    };
    ...
    function updateSummary() {
        const selectedLanguage = document.querySelector('input[name="bookLanguage"]:checked').value;
        const price = prices[selectedLanguage];
        const imageList = images[selectedLanguage];

        // Update title
        let editionText = "";
        switch (selectedLanguage) {
            case "marathi":
                editionText = "Marathi Edition - Part 1";
                break;
            case "marathi_part2":
                editionText = "Marathi Edition - Part 2";
                break;
            case "marathi_combo":
                editionText = "Marathi Combo (Part 1 + Part 2)";
                break;
            case "hindi":
                editionText = "Hindi Edition - Part 1";
                break;
        }
        document.getElementById("bookTitle").textContent = `अंतः अस्ति प्रारंभः (The End is the Beginning) - ${editionText}`;
        document.getElementById("bookPrice").textContent = price;

        // Update images
        const img1 = document.getElementById("bookImage1");
        const img2 = document.getElementById("bookImage2");
        img1.src = imageList[0];
        if (imageList.length > 1) {
            img2.src = imageList[1];
        ...
        document.getElementById("bookCharges").textContent = total;
        document.getElementById("totalAmount").textContent = total;
        document.getElementById("submit-button").textContent = `Pay ₹${total} Online and Place Order`;
    }
...
<div>
    ...
    <a href="tel:7499454645" class="footer-link">7499454645</a><br>
    © Copyright 2024 <a href="https://vaibhavdhus.com" target="_blank" class="footer-link">Vaibhav Dhus</a>. All Rights Reserved.<br>
    Developed by: 
    <a href="https://shubhsairajinfotech.com/" target="_blank" class="footer-link">
        <strong>Shubhsairaj Infotech Private Limited</strong>
    </a><br>
</div>
