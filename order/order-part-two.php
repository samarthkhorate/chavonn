...
<div class="row mb-3">
    ...
    <div class="col-sm-10">
        ...
        <div class="form-check mb-2">
            <input class="form-check-input" type="radio" name="bookLanguage" id="marathiPart1" value="marathi"  onclick="updateSummary()" />
            <label class="form-check-label" for="marathiPart1">Marathi Edition - Part 1 / मराठी आवृत्ती - भाग १</label>
        </div>
        <!-- Marathi Part 2 -->
        <div class="form-check mb-2">
            <input class="form-check-input" type="radio" name="bookLanguage" id="marathiPart2" value="marathi_part2" checked onclick="updateSummary()" />
