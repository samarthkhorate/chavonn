...
<noscript>
  ...
  src="https://www.facebook.com/tr?id=1765217447673079&ev=PageView&noscript=1"/>
</noscript>
<!-- End Meta Pixel Code -->
...
<script>
  ...
  affiliation: 'Ad Manager By Vikram',
  value: <?php echo $order['total_amount']; ?>.00,
  currency: 'INR',
  tax: 0.00,
  shipping: 0.00,
  items: [
    {
      item_name: '<?php echo $order['language']; ?>',
      item_id: '<?php echo $order['language']; ?>',
      price: <?php echo $order['total_amount']; ?>.00,
        ...
        <div class="card text-center">
            ...
            <div class="card-body">
                <h4 class="card-title mb-4">
                    <?= $payment_success ? 'Thank You for Your Order' : 'Payment Verification Failed' ?>
                </h4>
...
<p class="mb-2">आयुष्य बदलून टाकणारे पुस्तक ऑर्डर केल्याबद्दल आभार, अपेक्षा आहे की हे पुस्तक तुम्ही संपूर्ण वाचाल आणि त्याची अंमलबजावणी तुमच्या आयुष्यात कराल.</p>
<p class="mb-2">आपण ऑर्डर केलेले हे पुस्तक आपल्या पत्त्यावर ७ ते ८ दिवसांमध्ये मिळून जाईल.</p>
<p class="mb-0">धीर धरा, खचून जाऊ नका, शेवट हीच सुरूवात आहे लक्षात ठेवा आणि नवीन सुरुवात करा ♥️</p>
                    ...
                    <table class="table table-bordered">
                        <tbody>
                            <tr>
                                <th>Language</th>
                                <td><?= htmlspecialchars($order['language']) ?></td>
                            </tr>
                            <tr>
                                <th>Id</th>
