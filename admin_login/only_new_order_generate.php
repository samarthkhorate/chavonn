...
$query = "SELECT * FROM `tbl_old_orders` WHERE `payment_status` = 'paid'   AND `ship_status` != 'DELIVERED'   AND (`ship_shipment_id` IS NULL OR `ship_shipment_id` = '') ORDER BY `id` DESC;";
