...
<div class="container-fluid px-4">
  <h2 class="mt-4 mb-3">
    <i class="fa fa-truck text-success me-2"></i> Pending Shiprocket Orders
  </h2>
  ...
  <div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <div>
      <a href="https://pravarahealthcare.com/cron_send_orders_to_shiprocket.php" 
         target="_blank" 
         class="btn btn-primary btn-sm">
         <i class="fa fa-paper-plane"></i> Send Orders to Shiprocket
      </a>
    </div>
  </div>
